...
export const metadata = {
  ...
  description: "Selected software and AI projects focused on real-world impact",
};
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-muted-foreground text-pretty mb-8 ">
                  I love technology, but I care even more about people. My goal is to use code to make life a little easier for others. Whether I am working on a government project or a team hackathon, I try to build things that actually matter.
                    <br/>
                    The best reward for me isn't a certificate; it&apos;s seeing that my work has made a difference for someone. I want to continue growing as a developer so I can give back to my community and create opportunities for others.
                </p>
